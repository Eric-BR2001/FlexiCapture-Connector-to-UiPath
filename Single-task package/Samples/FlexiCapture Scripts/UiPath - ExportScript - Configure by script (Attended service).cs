...
if(Document.Properties.Has("WasVerified") && Document.Properties.Get("WasVerified") == bool.TrueString){
...
// Get a list of exportable fields name from a document and write the list to the dictionary.
// In Export Global Script Module should be added code from 
// UiPath - ExportGlobalScriptModule - Get exportable fields name from document script.
//Dictionary<string, string> pairs = new Dictionary<string, string>();
//List<string> fieldsName = Parser.GetFieldsName(Document);
//foreach(var fieldName in fieldsName){
//    pairs.Add(fieldName, fieldName);
//}
...
using (IAfcDmsConnector connector = factory.CreateConnector(DmsConnectorType.UiPath))
{
    ...
    // Export the document to UiPath Orchestrator.
